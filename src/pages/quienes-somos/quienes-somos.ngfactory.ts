...
import * as import0 from './quienes-somos';
...
export class Wrapper_QuienesSomosPage {
  /*private*/ _eventHandler:Function;
  context:import0.QuienesSomosPage;
  /*private*/ _changed:boolean;
  constructor(p0:any,p1:any) {
    this._changed = false;
    this.context = new import0.QuienesSomosPage(p0,p1);
  }
...
var renderType_QuienesSomosPage_Host:import2.RenderComponentType = import3.createRenderComponentType('',0,import4.ViewEncapsulation.None,([] as any[]),{});
class View_QuienesSomosPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.QuienesSomosPage>;
  _QuienesSomosPage_0_3:Wrapper_QuienesSomosPage;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_QuienesSomosPage_Host0,renderType_QuienesSomosPage_Host,import5.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import6.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'page-quienes-somos',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    this.compView_0 = new View_QuienesSomosPage0(this.viewUtils,this,0,this._el_0);
    this._QuienesSomosPage_0_3 = new Wrapper_QuienesSomosPage(this.injectorGet(import8.NavController,this.parentIndex),this.injectorGet(import9.NavParams,this.parentIndex));
    this.compView_0.create(this._QuienesSomosPage_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import7.ComponentRef_<any>(0,this,this._el_0,this._QuienesSomosPage_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.QuienesSomosPage) && (0 === requestNodeIndex))) { return this._QuienesSomosPage_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this._QuienesSomosPage_0_3.ngDoCheck(this,this._el_0,throwOnChange);
...
export const QuienesSomosPageNgFactory:import7.ComponentFactory<import0.QuienesSomosPage> = new import7.ComponentFactory<import0.QuienesSomosPage>('page-quienes-somos',View_QuienesSomosPage_Host0,import0.QuienesSomosPage);
const styles_QuienesSomosPage:any[] = ([] as any[]);
var renderType_QuienesSomosPage:import2.RenderComponentType = import3.createRenderComponentType('',0,import4.ViewEncapsulation.None,styles_QuienesSomosPage,{});
export class View_QuienesSomosPage0 extends import1.AppView<import0.QuienesSomosPage> {
  _el_0:any;
  ...
  _text_24:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_QuienesSomosPage0,renderType_QuienesSomosPage,import5.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import6.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._text_10 = this.renderer.createText((null as any),'¿Quiénes Somos?',(null as any));
