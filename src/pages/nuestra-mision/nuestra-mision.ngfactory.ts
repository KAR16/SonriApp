...
import * as import0 from './nuestra-mision';
...
export class Wrapper_NuestraMisionPage {
  /*private*/ _eventHandler:Function;
  context:import0.NuestraMisionPage;
  /*private*/ _changed:boolean;
  constructor(p0:any,p1:any) {
    this._changed = false;
    this.context = new import0.NuestraMisionPage(p0,p1);
  }
...
var renderType_NuestraMisionPage_Host:import2.RenderComponentType = import3.createRenderComponentType('',0,import4.ViewEncapsulation.None,([] as any[]),{});
class View_NuestraMisionPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.NuestraMisionPage>;
  _NuestraMisionPage_0_3:Wrapper_NuestraMisionPage;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_NuestraMisionPage_Host0,renderType_NuestraMisionPage_Host,import5.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import6.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'page-nuestra-mision',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    this.compView_0 = new View_NuestraMisionPage0(this.viewUtils,this,0,this._el_0);
    this._NuestraMisionPage_0_3 = new Wrapper_NuestraMisionPage(this.injectorGet(import8.NavController,this.parentIndex),this.injectorGet(import9.NavParams,this.parentIndex));
    this.compView_0.create(this._NuestraMisionPage_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import7.ComponentRef_<any>(0,this,this._el_0,this._NuestraMisionPage_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.NuestraMisionPage) && (0 === requestNodeIndex))) { return this._NuestraMisionPage_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this._NuestraMisionPage_0_3.ngDoCheck(this,this._el_0,throwOnChange);
...
export const NuestraMisionPageNgFactory:import7.ComponentFactory<import0.NuestraMisionPage> = new import7.ComponentFactory<import0.NuestraMisionPage>('page-nuestra-mision',View_NuestraMisionPage_Host0,import0.NuestraMisionPage);
const styles_NuestraMisionPage:any[] = ([] as any[]);
var renderType_NuestraMisionPage:import2.RenderComponentType = import3.createRenderComponentType('',0,import4.ViewEncapsulation.None,styles_NuestraMisionPage,{});
export class View_NuestraMisionPage0 extends import1.AppView<import0.NuestraMisionPage> {
  _el_0:any;
  ...
  _text_24:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_NuestraMisionPage0,renderType_NuestraMisionPage,import5.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import6.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._text_10 = this.renderer.createText((null as any),'Nuestra Misión',(null as any));
